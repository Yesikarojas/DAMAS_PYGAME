...
def dibujarFicha(screen, x, y, color, dimension):
    if color == "blanco":
        color_ficha = BLANCO
    elif color == "negro":
        color_ficha = NEGRO
    else:
        raise ValueError("Color de ficha no válido")
    
    pygame.draw.circle(screen, color_ficha, [(x+0.5)*dimension, (y+0.5)*dimension], dimension//2-5)
...
def main():
    ...
    tamanio_fuente = 30
    seleccion = ['Z', -1]
    fuente = pygame.font.Font("Tablero/fuentes/AliceandtheWickedMonster.ttf", tamanio_fuente)
